...
public class SQLiteDataAdapter implements IDataAdapter {
    ...
    public int saveUser(UserModel user) {
        try {
            Statement stmt = conn.createStatement();
            UserModel u = loadUser(user.mUsername); // check if this product exists
            if (u != null) {
                String sql = "INSERT or REPLACE INTO Users(Username, Password, Fullname, Usertype) VALUES " + user;
                System.out.println(sql);
