...
public class SQLiteDataAdapter implements IDataAdapter {
    ...
    public int saveCustomer(CustomerModel customer) {
        try {
            String sql = "INSERT or REPLACE INTO Customers(CustomerId, Name, Phone, Address) VALUES " + customer; //sql insert string
    ...
    public PurchaseModel loadPurchase(int id) {
        ...
        try {
            String sql = "SELECT PurchaseID, CustomerID, ProductID, Price, Quantity, Cost, Tax, TotalCost, DateTime FROM Purchases WHERE PurchaseID = " + id;
            Statement stmt = conn.createStatement();
            ResultSet rs = stmt.executeQuery(sql);
            if (rs.next()) {
                ...
                purchase.mDate = rs.getString("DateTime");
            }
    ...
    public int savePurchase(PurchaseModel purchase) {
        try {
            String sql = "INSERT or REPLACE INTO Purchases(PurchaseID, CustomerID, ProductID, Price, Quantity, Cost, Tax, TotalCost, DateTime) VALUES " + purchase;
            System.out.println(sql);
            Statement stmt = conn.createStatement();
            stmt.executeUpdate(sql);
